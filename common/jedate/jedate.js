...
;(function(root, factory) {
	...
	*/
    ...
    //语言版本(国际化)
    //if(language=="en"){
//    	jeDt.weeks = [ "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" ];
//    	close = "close";
//    	clear = 'clear';
//    	today = 'today';
//    	sure  = 'confirm';
//    	selecthms = 'Select the minutes and seconds';
//    	hour  = 'hour';
//    	minute= 'minute';
//    	second= 'second';
...
//    }else{
  ...
  //  }
    ...
    jeDt.setHtml = function(opts, self, lyerCell) {
        ...
        var bothmsStr = !isYYMM ? '<div class="botflex jedatehmsshde"><ul class="jedatehms"><li><em></em><i>:</i></li><li><em></em><i>:</i></li><li><em></em></li></ul></div>' + '<div class="botflex jedatebtn"><span class="jedateok">'+sure+'</span><span class="jedatetodaymonth">'+today+'</span><span class="jedateclear">'+clear+'</span></div>' :'<div class="botflex jedatebtn"><span class="jedateok">'+sure+'</span><span class="jedatetodaymonth">'+thismonth+'</span><span class="jedateclear">'+clear+'</span></div>';
        var datebotStr = '<div class="jedatebot">' + bothmsStr + "</div>";
        var datehmschoose = '<div class="jedateprophms ' + (ishhmm ? "jedatepropfix" :"jedateproppos") + '" prop="true"><div class="jedatepropcon"><div class="jedatehmstitle">'+selecthms+'<div class="jedatehmsclose">&times;</div></div><div class="jedateproptext">'+hour+'</div><div class="jedateproptext">'+minute+'</div><div class="jedateproptext">'+second+'</div><div class="jedatehmscon jedateprophours"></div><div class="jedatehmscon jedatepropminutes"></div><div class="jedatehmscon jedatepropseconds"></div></div></div>';
    ...
    jeDt.getDateStr = function(opts, lyerCell, y, m, d) {
        ...
        jeDt.each(QD(lyerCell + " .jedateyear"), function(i, elem) {
            jeDt.text(elem, y /*+ "年"*/).attr(elem, "data-year", y);  //顶部的年
        });
        jeDt.each(QD(lyerCell + " .jedatemonth"), function(i, elem) {
            jeDt.text(elem, m /*+ "月"*/).attr(elem, "data-month", m); //顶部的月
        });
        ...
        function eachYears(YY) {
            ...
            jeDt.each(new Array(15), function(i) {
                if (i === 7) {
                    ...
                    eachStr += "<li " + (getyear == YY ? 'class="action"' :"") + ' data-y="' + YY + '">' + YY + /*"年*/ "</li>";//下拉当前年份
                } else {
                    eachStr += '<li data-y="' + (YY - 7 + i) + '">' + (YY - 7 + i) + /*"年*/"</li>"; //下拉选择年份
                }
            });
            return eachStr;
        }
        ...
        function setYearMonth(YY, ymlen) {
            ...
            if (ymlen == 12) {
                jeDt.each(jeDt.montharr, function(i, val) {
                    ...
                    ymStr += "<li " + (getmonth == val ? 'class="action"' :"") + ' data-m="' + val + '">' + val + /*"月*/"</li>";//下拉选择月份
                });
